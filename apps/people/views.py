...
class PeopleImageView(generic.DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        img = Image.open("media/layer.jpg", mode='r')
        draw = ImageDraw.Draw(img)
        font = ImageFont.truetype("media/font.ttf", size=46)
        ...
        img.save(f"media/images/layer-{self.object.guid}.jpg")
        
        return FileResponse(open(f"media/images/layer-{self.object.guid}.jpg", 'rb'), content_type='image/jpeg')
